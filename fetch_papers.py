...
if __name__ == "__main__":
  ...
  parser.add_argument('--search-query', type=str,
                      default='cat:hep-ex+OR+cat:nucl-ex+OR+cat:hep-ph+OR+hep-lat+OR+cat:physics.data-an+OR+cat:astro-ph.HE+OR+cat:cs.CV+OR+cat:cs.AI+OR+cat:cs.LG+OR+cat:cs.NE+OR+cat:stat.ML',
